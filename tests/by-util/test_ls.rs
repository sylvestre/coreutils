...
// spell-checker:ignore (words) fakeroot setcap clocale
#![allow(
    ...
    fn check_quoting_dirname(dirname: &str, checks: &[(&str, &str, &str)], extra_args: &[&str]) {
        for (qt_style, regular_mode, dir_mode) in checks {
            ...
            let expected = format!(
                "{}:\n{}\n\n{}:\n",
                match *qt_style {
                    "shell-always" | "shell-escape-always" | "locale" => "'.'",
                    "c" | "clocale" => "\".\"",
                    _ => ".",
                },
                regular_mode,
    ...
    fn test_ls_quoting_space() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("c", "\"dir name\"", "\"./dir name\""),
                ("clocale", "\"dir name\"", "\"./dir name\""),
                ("locale", "'dir name'", "'./dir name'"),
    ...
    fn test_ls_quoting_carriage_return() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'dir\\rname'", "'./dir\\rname'"),
                ("clocale", "\"dir\\rname\"", "\"./dir\\rname\""),
    ...
    fn test_ls_quoting_bell() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'dir\\aname'", "'./dir\\aname'"),
                ("clocale", "\"dir\\aname\"", "\"./dir\\aname\""),
    ...
    fn test_ls_quoting_backspace() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'dir\\bname'", "'./dir\\bname'"),
                ("clocale", "\"dir\\bname\"", "\"./dir\\bname\""),
    ...
    fn test_ls_quoting_vertical_tab() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'dir\\vname'", "'./dir\\vname'"),
                ("clocale", "\"dir\\vname\"", "\"./dir\\vname\""),
    ...
    fn test_ls_quoting_formfeed() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'dir\\fname'", "'./dir\\fname'"),
                ("clocale", "\"dir\\fname\"", "\"./dir\\fname\""),
    ...
    fn test_ls_quoting_open_bracket() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'[-open_bracket'", "'./[-open_bracket'"),
                ("clocale", "\"[-open_bracket\"", "\"./[-open_bracket\""),
    ...
    fn test_ls_quoting_close_bracket() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "']-close_bracket'", "'./]-close_bracket'"),
                ("clocale", "\"]-close_bracket\"", "\"./]-close_bracket\""),
    ...
    fn test_ls_quoting_open_brace() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'{-open_brace'", "'./{-open_brace'"),
                ("clocale", "\"{-open_brace\"", "\"./{-open_brace\""),
    ...
    fn test_ls_quoting_close_brace() {
        check_quoting_dirname(
            ...
            &[
                ...
                ("locale", "'}-close_brace'", "'./}-close_brace'"),
                ("clocale", "\"}-close_brace\"", "\"./}-close_brace\""),
