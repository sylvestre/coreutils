...
test-after-help = Quitter avec le statut déterminé par EXPRESSION.
  ...
  l'argument fautif dès que la sortie d'erreur est un terminal. Mettre UU_DIAG
  à 0 pour toujours obtenir le message sur une seule ligne, ou à 1 pour
  toujours obtenir le rapport.
