...
# Reflète intentionnellement range-diag-help-list-syntax de uucore/locales/errors.
numfmt-diag-help-field-syntax = une liste s'écrit N, N-M, N- ou -M, séparés par des virgules, comme --field=1,3-5
