...
expr-after-help = Print the value of EXPRESSION to standard output. A blank line below
  ...
  - UU_DIAG: report errors with the expression echoed back and a caret under
    the offending argument. On by default when stderr is a terminal; set to 0
    to always get the single-line message, or to 1 to always get the report
