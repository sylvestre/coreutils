...
expr-after-help = Afficher la valeur de EXPRESSION sur la sortie standard. Une ligne vide ci-dessous
  ...
  - UU_DIAG : signaler les erreurs en réaffichant l'expression avec un caret
    sous l'argument fautif. Actif par défaut si la sortie d'erreur est un
    terminal ; mettre à 0 pour toujours obtenir le message sur une seule
    ligne, ou à 1 pour toujours obtenir le rapport
