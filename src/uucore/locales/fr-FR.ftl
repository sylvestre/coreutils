...
# Ce sont des termes génériques qui ne dépendent pas de fonctionnalités de commandes spécifiques
...
clap-error-unexpected-argument = { $error_word } : argument inattendu '{ $arg }'
